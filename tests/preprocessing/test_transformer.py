...
def test_standardize_columns():
    ...
    dataframe = pd.DataFrame({" Product Name ": ["A"], "Price Value": [100]})
...
def test_convert_datetime_columns():
    ...
    dataframe = pd.DataFrame({"created_date": ["2026-01-01", "2026-01-02"]})
...
def test_transform_pipeline():
    ...
    dataframe = pd.DataFrame({"Created Date": ["2026-01-01"], " Product Name ": ["A"]})
