...
def create_retriever():
    ...
    index.add("memory-001", {"topic": "optimization", "type": "learning"})

    index.add("memory-002", {"topic": "decision", "type": "learning"})
...
def test_knowledge_retriever_retrieve():
    ...
    result = retriever.retrieve("memory-001")
...
def test_knowledge_retriever_search():
    ...
    results = retriever.search("type", "learning")
...
def test_knowledge_retriever_exists():
    ...
    assert retriever.exists("memory-001")
