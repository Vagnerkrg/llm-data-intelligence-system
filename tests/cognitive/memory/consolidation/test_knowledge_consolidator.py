    ...
    return [
        {
            ...
            "source_pattern": "query-pattern",
            "confidence": 0.95,
        },
        {
            "content": "Weak information",
            "source_pattern": "weak-pattern",
            "confidence": 0.2,
        },
    ]
...
def test_knowledge_consolidator_create():
    ...
    result = consolidator.consolidate(create_candidates())
...
def test_knowledge_consolidator_filter():
    ...
    consolidator = KnowledgeConsolidator(confidence_threshold=0.9)
...
def test_knowledge_consolidator_count():
    ...
    consolidator.consolidate(create_candidates())
