...
def create_knowledge(
    knowledge_id="knowledge_001", content="Agent learned successful decision pattern"
):
    return ConsolidatedKnowledge(
        ...
        confidence=0.95,
        metadata={"source": "feedback_loop", "type": "cognitive_pattern"},
    )
...
def test_cognitive_knowledge_bridge_add():
    ...
    bridge.add_knowledge(knowledge)
...
def test_cognitive_knowledge_bridge_retrieve():
    ...
    result = bridge.retrieve("knowledge_001")
...
def test_cognitive_knowledge_bridge_exists():
    ...
    assert bridge.exists("knowledge_001") is True
...
def test_cognitive_knowledge_bridge_search():
    ...
    bridge.add_knowledge(
        create_knowledge(content="Successful planning pattern extracted")
    )

    result = bridge.search("planning")
...
def test_cognitive_knowledge_bridge_consolidate():
    ...
    knowledge_list = [
        create_knowledge("knowledge_001"),
        create_knowledge("knowledge_002"),
    ]

    result = bridge.consolidate(knowledge_list)
...
def test_cognitive_knowledge_bridge_metadata():
    ...
    bridge.add_knowledge(create_knowledge())
