...
def test_register_evaluator():
    ...
    registry.register("memory", evaluator)
...
def test_get_evaluator():
    ...
    registry.register("planner", evaluator)
...
def test_list_evaluators():
    ...
    registry.register("execution", DummyEvaluator())

    registry.register("memory", DummyEvaluator())
