from src.cognitive.evaluation.evaluators.reasoning_evaluator import ReasoningEvaluator
...
def test_reasoning_evaluator_with_output():
    ...
    context = EvaluationContext(agent_id="agent-001", output_data="logical answer")
