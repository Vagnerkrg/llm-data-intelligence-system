...
def test_quality_metrics_creation():
    ...
    metrics = QualityMetrics(evaluator="reasoning", quality_score=0.90)
...
def test_quality_metrics_score_range():
    ...
    metrics = QualityMetrics(evaluator="planning", quality_score=0.75)
...
def test_quality_metrics_threshold():
    ...
    metrics = QualityMetrics(evaluator="memory", quality_score=0.85, threshold=0.80)
