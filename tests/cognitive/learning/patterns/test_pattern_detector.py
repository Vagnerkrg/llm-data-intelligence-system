...
def test_pattern_detector_updates_existing_pattern():
    ...
    detector.detect(pattern_id="error-pattern", description="Falha recorrente")

    pattern = detector.detect(
        pattern_id="error-pattern", description="Falha recorrente"
    )
...
def test_pattern_detector_returns_patterns():
    ...
    detector.detect(pattern_id="pattern-001", description="Teste")
