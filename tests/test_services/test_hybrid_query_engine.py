...
class FakeRAGEngine:
    def query(self, question):
        ...
        return {"type": "rag", "answer": "RAG answer"}


class FakeAnalysisAgent:
    def run(self, question):

        return {"type": "analysis", "operation": "count_rows", "result": 10}
...
class FakeDecisionEngine:
    def decide(self, rag_result, analysis_result):
        ...
        if rag_result and analysis_result:
            return {"type": "hybrid", "answer": analysis_result}
...
class TestHybridQueryEngine:
    def test_analysis_route(self):
        ...
        result = engine.query("Quantos produtos existem?")
    ...
    def test_rag_route(self):
        ...
        result = engine.query("Explique os produtos.")
    ...
    def test_hybrid_route(self):
        ...
        result = engine.query("Qual categoria possui mais produtos?")
