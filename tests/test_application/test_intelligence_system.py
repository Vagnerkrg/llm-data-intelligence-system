...
class TestIntelligenceSystem:
    def test_analysis_response(self):
        ...
        result = system.ask("Quantos produtos existem?")
    ...
    def test_rag_response(self):
        ...
        system.engine = FakeEngine(
            {
                "route": "rag",
                "result": {"type": "rag", "answer": {"answer": "rag response"}},
            }
        )

        result = system.ask("Quais produtos aparecem?")
    ...
    def test_unknown_response(self):
        ...
        system.engine = FakeEngine({"route": "unknown", "result": {}})
        ...
        assert result.answer == ("Não foi possível processar a pergunta.")
