...
def test_dynamic_planner_uses_strategy_for_analytics_request():
    ...
    plan = planner.create_plan("Analise os dados de vendas e encontre padrões")
...
def test_dynamic_planner_uses_strategy_for_document_request():
    ...
    plan = planner.create_plan("Explique o conteúdo deste documento")
...
def test_dynamic_planner_returns_valid_execution_plan():
    ...
    plan = planner.create_plan("Faça uma análise estatística dos dados")
