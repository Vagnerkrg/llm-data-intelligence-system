...
def test_agent_controller_creates_execution_plan():
    ...
    plan = controller.create_plan("Analyze sales dataset")
...
def test_agent_controller_plan_contains_expected_steps():
    ...
    plan = controller.create_plan("Analyze customer information")
...
def test_agent_controller_plan_steps_start_pending():
    ...
    plan = controller.create_plan("Test planning workflow")
