...
class MockPlanner:
    ...
    def create_plan(self, question: str):
        ...
        return DynamicExecutionPlanner().create_plan(question)
...
def test_agent_runtime_uses_injected_planner():
    ...
    runtime.create_initial_plan("Analise os dados de vendas")
...
def test_agent_runtime_injected_planner_generates_valid_plan():
    ...
    plan = runtime.create_initial_plan("Explique este documento")
