...
def test_register_tool():
    ...
    result = registry.get_tool("analytics")
...
def test_list_tools():
    ...
    registry.register_tool(AnalyticsTool())
...
def test_registry_returns_tool_metadata():
    ...
    assert "statistics" in metadata[0].capabilities
...
def test_find_tools_by_capability():
    ...
    tools = registry.find_tools_by_capability("statistics")
...
def test_list_active_tools():
    ...
    registry.register_tool(DisabledTestTool())
...
def test_ignore_disabled_tools():
    ...
    tools = registry.find_active_tools_by_capability("testing")
