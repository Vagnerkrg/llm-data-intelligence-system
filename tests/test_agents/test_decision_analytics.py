...
def create_trace(tool, confidence, success):
...
def test_total_decisions():
    ...
    store.add(create_trace("analytics", 0.9, True))
...
def test_success_rate():
    ...
    store.add(create_trace("analytics", 0.5, False))
...
def test_average_confidence():
    ...
    store.add(create_trace("analytics", 0.8, True))

    store.add(create_trace("analytics", 0.6, True))
...
def test_tool_usage_and_best_tool():
    ...
    store.add(create_trace("search", 0.7, True))
