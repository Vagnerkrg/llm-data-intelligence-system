...
def test_execution_plan_add_step():
    ...
    step = PlanStep(step_id=1, action="execute_tool", description="Run analytics")
...
def test_execution_plan_next_step():
    ...
    step = PlanStep(step_id=1, action="analysis", description="Execute analysis")
...
def test_execution_plan_completion():
    ...
    plan = ExecutionPlan(objective="Complete task")

    step = PlanStep(step_id=1, action="test", description="Test execution")
