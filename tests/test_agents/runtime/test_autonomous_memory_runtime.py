from src.agents.runtime.autonomous_memory_runtime import AutonomousMemoryRuntime
...
def test_autonomous_memory_runtime_stores_decision():
    ...
    assert runtime.count_memories() == 1
...
def test_autonomous_memory_runtime_retrieves_decision():
    ...
    stored = runtime.retrieve_learning(decision.decision_id)
...
def test_autonomous_memory_runtime_supports_custom_memory():
    ...
    runtime = AutonomousMemoryRuntime(memory=memory)
