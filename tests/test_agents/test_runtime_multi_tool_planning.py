...
def test_runtime_multi_tool_planning():
    ...
    context = runtime.prepare("Analise os dados e gere um relatório")
...
def test_runtime_multi_tool_planning_contains_multiple_steps():
    ...
    context = runtime.prepare("Leia o documento e faça uma análise")
...
def test_runtime_multi_tool_planning_supports_different_requests():
    ...
    analytics_context = runtime.prepare("Analise vendas")

    document_context = runtime.prepare("Explique documento")
