...
def test_dynamic_planner_adaptive_replanning():
    ...
    initial_plan = planner.create_plan("Analise vendas")
...
def test_dynamic_planner_adaptive_replanning_generates_new_plan():
    ...
    first_plan = planner.create_plan("Analise vendas")

    second_plan = planner.create_plan("Analise vendas com estatísticas")
...
def test_dynamic_planner_adaptive_replanning_changes_steps():
    ...
    plan = planner.create_plan("Faça análise e gere relatório")
