...
def test_agent_runtime_context_tracking():
    ...
    context = runtime.prepare("Analise os dados")

    assert context.question == ("Analise os dados")
...
def test_agent_runtime_context_tracking_has_execution_plan():
    ...
    context = runtime.prepare("Explique o documento")
...
def test_agent_runtime_context_tracking_updates_step():
    ...
    context = runtime.prepare("Faça análise estatística")
