...
def test_agent_controller_runtime_result_handling():
    ...
    result = controller.handle_request("Analise os dados de clientes")
...
def test_agent_controller_runtime_result_contains_context():
    ...
    result = controller.handle_request("Faça uma análise estatística")
...
def test_agent_controller_runtime_result_preserves_execution_flow():
    ...
    result = controller.handle_request("Explique um documento")
