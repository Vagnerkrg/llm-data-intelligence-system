from src.agents.memory.contracts.memory_request import MemoryRequest


def test_should_create_memory_request():

    request = MemoryRequest(query="buscar histórico do agente")

    assert request.query == ("buscar histórico do agente")
