...
def create_lifecycle_manager():
    ...
    consolidator = MemoryConsolidator(relevance_analyzer=analyzer)

    return MemoryLifecycleManager(consolidator=consolidator, decay=MemoryDecay())
