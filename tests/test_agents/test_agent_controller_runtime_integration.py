...
def test_agent_controller_runtime_integration():
    ...
    result = controller.handle_request("Analise os dados de vendas")
...
def test_agent_controller_runtime_generates_dynamic_plan():
    ...
    context = controller.handle_request("Explique este documento")
...
def test_agent_controller_runtime_supports_multiple_intents():
    ...
    document_context = controller.handle_request("Resuma este documento")
