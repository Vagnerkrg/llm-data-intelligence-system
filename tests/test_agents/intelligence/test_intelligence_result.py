...
def test_intelligence_result_creation():
    ...
    result = IntelligenceResult(answer="Final answer.")
...
def test_intelligence_result_to_dict():
    ...
    result = IntelligenceResult(answer="Response", confidence=0.9)
...
def test_intelligence_result_metadata():
    ...
    result = IntelligenceResult(answer="Test", metadata={"source": "agent"})
