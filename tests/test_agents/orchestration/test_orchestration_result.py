...
def test_orchestration_result_creation():
    ...
    result = OrchestrationResult(status="completed", result={"answer": "ok"})
...
def test_orchestration_result_to_dict():
    ...
    result = OrchestrationResult(
        status="completed", result="data", reasoning="analysis"
    )
...
def test_orchestration_result_metadata():
    ...
    result = OrchestrationResult(status="completed", metadata={"source": "test"})
