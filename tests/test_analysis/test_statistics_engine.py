...
class TestStatisticsEngine:
    ...
    def test_count_rows(self):
        ...
        result = self.engine.count_rows(dataframe)
    ...
    def test_columns(self):
        ...
        dataframe = pd.DataFrame([{"id": 1, "category": "phone"}])

        result = self.engine.columns(dataframe)
    ...
    def test_value_counts(self):
        ...
        dataframe = pd.DataFrame(
            [{"category": "phone"}, {"category": "book"}, {"category": "phone"}]
        )

        result = self.engine.value_counts(dataframe, "category")
    ...
    def test_missing_column(self):
        ...
        dataframe = pd.DataFrame([{"category": "phone"}])

        result = self.engine.value_counts(dataframe, "invalid")
