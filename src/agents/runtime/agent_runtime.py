...
class AgentRuntime:
    ...
    def run_cognitive_learning(
        ...
        """
        Execute the cognitive learning loop.

        The runtime only coordinates the loop and persists its
        intermediate results in ExecutionContext.
        """
        ...
        context.set_learning_loop_result(
            result
        )
