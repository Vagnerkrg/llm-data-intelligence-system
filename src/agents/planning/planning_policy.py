...
class PlanningPolicy:
    ...
    def get_steps(
        self, intent: str, required_capabilities: List[str] = None, strategy: str = None
    ) -> List[Dict[str, str]]:
        """
        ...
        required_capabilities = required_capabilities if required_capabilities else []
        ...
        if intent == "analytics":
            return [
                {
                    "action": "analyze_data",
                    "description": "Analyze requested data "
        ...
        if intent == "search":
            return [
                ...
                },
                {
                    ...
                    "description": "Evaluate retrieved information.",
                },
            ]
            ...
            return [
                {
                    ...
                    "description": "Apply general reasoning to understand request.",
                }
            ]
        ...
        if "data_analysis" in required_capabilities:
            return [{"action": "analyze_data", "description": "Execute data analysis."}]

        if "information_retrieval" in required_capabilities:
            return [
                {
                    "action": "retrieve_information",
                    "description": "Execute information retrieval.",
                }
            ]
        ...
        return [
            {"action": "execute_tool", "description": "Execute selected capability."}
        ]
