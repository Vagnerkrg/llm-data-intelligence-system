    ...
    def create_plan(self, goal: Goal) -> ExecutionPlan:
        ...
        steps = [
            PlanStep(
                ...
                description=("Analyze goal and select the best execution capability."),
            ),
            PlanStep(
                step_id=2,
                action="execute_tool",
                description=("Execute selected capability."),
            ),
            PlanStep(
                step_id=3,
                action="generate_response",
                description=("Generate final response aligned with the goal."),
            ),
        ]
