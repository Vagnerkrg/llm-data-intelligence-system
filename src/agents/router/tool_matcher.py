...
class ToolMatcher:
    ...
    def match(self, question: str, tools: List[ToolMetadata]) -> RoutingResult:
        """
        ...
        if best_match:
            return RoutingResult(
                ...
                confidence=0.85,
                reason=("Matched tool capability: " + best_capability),
            )

        return RoutingResult(
            tool=None, confidence=0.0, reason=("No tool capability match found.")
        )
