...
class AgentIntelligenceMonitor:
    ...
    def generate_report(self) -> Dict:
        ...
        return {
            ...
            "success_rate": (self.decision_analytics.success_rate()),
            "average_confidence": (self.decision_analytics.average_confidence()),
            "best_tool": (self.decision_analytics.best_tool()),
            "tool_usage": (self.decision_analytics.tool_usage()),
            "routing_total": (self.routing_metrics.total_routes()),
            "routing_success_rate": (self.routing_metrics.success_rate()),
            "routing_average_confidence": (self.routing_metrics.average_confidence()),
            "performance": {
                "total_decisions": (self.performance_analyzer.total_decisions()),
