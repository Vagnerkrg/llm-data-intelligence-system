...
from src.agents.memory.storage.knowledge_store import KnowledgeStore
...
class InMemoryKnowledgeStore(KnowledgeStore):
    ...
    def __init__(self):
        ...
        self._knowledge: Dict[str, CognitiveKnowledge] = {}
    ...
    def list_all(self) -> List[CognitiveKnowledge]:
