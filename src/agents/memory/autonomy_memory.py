...
class AutonomyMemory:
    ...
    def store(self, decision) -> MemoryEntry:
        """
        ...
        self._memory[decision.decision_id] = entry

        return entry

    def store_learning(self, signal: "LearningSignal") -> MemoryEntry:
        """
        ...
        entry = MemoryEntry(
            ...
            metadata={"source": signal.source, "confidence": signal.confidence},
        )

        self._memory[signal.signal_id] = entry
    ...
    def get_learning(self, signal_id: str) -> Optional[Dict[str, Any]]:
        """
        Retrieve learning signal data.
        """

        entry = self._memory.get(signal_id)
    ...
    def list_learning(self) -> List[MemoryEntry]:
        """
