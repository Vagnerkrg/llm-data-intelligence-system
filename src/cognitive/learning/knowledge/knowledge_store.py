...
class KnowledgeStore:
    ...
    def save(self, knowledge: ConsolidatedKnowledge) -> None:
        """
    ...
    def get(self, knowledge_id: str) -> Optional[ConsolidatedKnowledge]:
        """
    ...
    def list_all(self) -> List[ConsolidatedKnowledge]:
        """
