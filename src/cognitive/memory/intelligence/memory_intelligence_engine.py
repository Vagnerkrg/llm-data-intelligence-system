...
class MemoryIntelligenceEngine:
    ...
    def __init__(self):
        ...
        self.knowledge_retriever = KnowledgeRetriever(self.memory_index)
    ...
    def store(self, content: str) -> str:
        ...
        memory_id = self.memory_index.add(metadata={"content": content})

        self.learning_manager.store(memory_id, content)
    ...
    def search(self, query: str) -> List:
        ...
        return self.knowledge_retriever.search(query)
