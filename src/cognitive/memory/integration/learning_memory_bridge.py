...
class LearningMemoryBridge:
    ...
    def __init__(self, memory_manager: LearningMemoryManager):
        ...
        self._knowledge_cache: Dict[str, ConsolidatedKnowledge] = {}

    def store_learning(self, knowledge: ConsolidatedKnowledge) -> Dict[str, Any]:
        """
        Armazena conhecimento aprendido na memória.
        """

        self.memory_manager.store(knowledge.knowledge_id, knowledge.content)

        self._knowledge_cache[knowledge.knowledge_id] = knowledge

        return {"stored": True, "knowledge_id": knowledge.knowledge_id}

    def retrieve_learning(self, knowledge_id: str) -> Optional[ConsolidatedKnowledge]:
        """
        Recupera conhecimento completo.
        """

        if not self.memory_manager.exists(knowledge_id):
            return None

        return self._knowledge_cache.get(knowledge_id)
    ...
    def exists(self, knowledge_id: str) -> bool:
        ...
        return self.memory_manager.exists(knowledge_id)
